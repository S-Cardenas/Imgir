...
image2 = Image.create!(title: "another stupid cat gif", user_id: user1.id, private: true, description: "I am not the most creative when it comes to cat uploads.")
image3 = Image.create!(title: "a very intelligent cat jpeg", user_id: user3.id, private: false, description: "Look at how smart this cat is. What a brilliant jpeg.")
